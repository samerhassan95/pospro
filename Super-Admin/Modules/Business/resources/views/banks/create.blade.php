<div class="modal fade" id="banks-create-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ __('Add Bank Account') }}</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="{{ __('Enter Bank Name') }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
