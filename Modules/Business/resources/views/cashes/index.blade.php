            ...
            <div class="card">
                <div class="card-bodys">
                    ...
                    <div class="table-header p-16">
                        ...
                        <a type="button" href="#cashes-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"><i class="fas fa-plus-circle me-1"></i>{{ __('Add Cash Account') }}</a>
                        @endusercan
                    </div>

                    <div class="table-top-form p-16-0">
                        <form action="{{ route('business.cashes.filter') }}" method="post" class="filter-form" table="#cashes-data">
                            @csrf
...
@push('modal')
    ...
    @include('business::cashes.create')
    @include('business::cashes.edit')
@endpush
