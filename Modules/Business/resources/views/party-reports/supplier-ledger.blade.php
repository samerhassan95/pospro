        ...
        <div class="container-fluid">
            <div class="card">
                        ...
                        <div class="table-top-left d-flex gap-3">
                            <div class="table-search position-relative d-print-none">
                                <input class="form-control searchInput" type="text" name="search"
                                    placeholder="{{ __('Search by name, phone or email...') }}" id="supplierSearch">
                ...
                <div class="responsive-table m-0">
                    <table class="table" id="supplierLedgerTable">
                        <thead>
                            <tr>
                                <th>{{ __('SL') }}</th>
                                <th>{{ __('Name') }}</th>
                                    ...
                                    <td class="d-print-none">
                                        <div class="dropdown table-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="{{ route('business.supplier-ledger.show', $party->id) }}" class="dropdown-item">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="empty-state">
                                            ...
                                            <p class="text-muted">{{ __('No supplier transactions have been recorded yet.') }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
...
<script>
    ...
    $('#supplierSearch').on('keyup', function() {
        ...
        $('#supplierLedgerTable tbody tr').filter(function() {
