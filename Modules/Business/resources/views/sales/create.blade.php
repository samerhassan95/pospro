...
@push('css')
    ...
    <style>
        ...
        .pos-option-btn:hover { border-color: var(--clr-primary); color: var(--clr-primary); }
        .pos-option-btn.active { border-color: var(--clr-primary); background: #fff5f0; color: var(--clr-primary); }
        .pos-option-btn svg { width: 16px; height: 16px; }

        /* Add to Cart Button */
        .pos-add-to-cart-btn { width: 100%; padding: 12px; background: var(--clr-primary); color: #fff; border: none; border-radius: 100px; font-size: 14px; font-weight: 600; cursor: pointer; transition: all 0.3s; }
        .pos-add-to-cart-btn:hover { background: var(--clr-secondary); transform: scale(1.02); }
