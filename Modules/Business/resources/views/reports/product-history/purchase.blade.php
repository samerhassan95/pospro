            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-header p-16">
                        <h4>{{ __('Product Purchase History') }}</h4>
                    </div>

                    <div class="row mb-3 p-16">
                        <div class="col-md-6 offset-md-6">
                            <form action="{{ route('business.product-purchase-history.index') }}" method="get">
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="card-text fw-bold text-success">{{ $total_purchase_qty }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="card-text fw-bold text-primary">{{ $total_sale_qty }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td class="fw-bold text-success">{{ $product->purchaseDetails->sum('quantities') }}</td>
                                        <td class="fw-bold text-primary">{{ $product->saleDetails->sum('quantities') }}</td>
                                    </tr>
                                @empty
                                    <tr>
