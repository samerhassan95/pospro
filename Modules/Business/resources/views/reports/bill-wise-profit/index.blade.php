        ...
        <div class="card">
            <div class="card-bodys">
                <div class="table-header p-16 d-print-none">
                    <h4>{{ __('Bill Wise Profit Report') }}</h4>
                </div>

                <div class="table-header justify-content-center border-0 d-none d-block d-print-block text-center">
                    @include('business::print.header')
                    <h4 class="mt-2">{{ __('Bill Wise Profit Report') }}</h4>
                </div>

                <div class="table-top-form p-16">
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <form action="{{ route('business.bill-wise-profit-reports.filter') }}" method="post" class="report-filter-form" table="#bill-wise-profit-data">
                            @csrf
                    ...
                    <div class="table-top-btn-group d-print-none">
                        <ul>
                            <li>
                                <a href="{{ route('business.bill-wise-profit-reports.csv') }}">
                                    <img src="{{ asset('assets/images/logo/csv.svg') }}" alt="">
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('business.bill-wise-profit-reports.excel') }}">
            ...
            <div class="responsive-table m-0">
                <table class="table" id="datatable">
                    ...
                    <tbody id="bill-wise-profit-data">
                        @include('business::reports.bill-wise-profit.datas')
                    </tbody>
                </table>
            </div>
            <div class="mt-3">
