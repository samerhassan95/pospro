            ...
            <div class="card">
                <div class="card-bodys">
                    <div class="table-header p-16 d-print-none">
                        <h4>{{ __('Sale Commission Reports') }}</h4>
                    </div>

                    <div class="table-header justify-content-center border-0 text-center d-none d-block d-print-block">
                        @include('business::print.header')
                        <h4 class="mt-2">{{ __('Sale Commission Reports') }}</h4>
                    </div>

                    <div class="table-top-form p-16">
                        <form action="{{ route('business.sale-commissions.filter') }}" method="post" class="filter-form" table="#sale-commission-data">
                            @csrf
                            <div class="table-top-left d-flex gap-3">
                                ...
                                <div class="table-search position-relative d-print-none">
                                    <input class="form-control searchInput" type="text" name="search"
                                        placeholder="{{ __('Search by invoice or sales person...') }}" value="{{ request('search') }}">
                ...
                <div class="responsive-table m-0" id="sale-commission-data">
