...
<div class="order-sidebar">
    ...
    <div class="order-details-section">
        <h3 class="section-title">{{ __('Purchase Details') }}</h3>
        ...
        <div class="order-info-line">
            ...
            <span class="phone-number" id="selected-customer-phone">
    ...
    <div class="order-summary-section">
        ...
        <div class="summary-row vat-row">
            ...
            <div class="vat-controls">
                <span class="summary-value" id="vat_display">{{ currency_format($purchase->vat_amount ?? $purchase->vat_percent ?? 0, currency: business_currency()) }}</span>
