...
(function () {
            ...
            try {
                ...
                if (modalOverlay) {
                    ...
                    if (paymentTypeInput && !paymentTypeInput.value) {
                        console.log(
                            "⚠️ Payment type is empty, but it should have a default value from Blade",
                        );
                    } else if (paymentTypeInput) {
                        console.log(
                            "✅ Payment type already set:",
    ...
    function updatePaymentCalculations() {
        ...
        document.getElementById("modal-amount-paid").innerHTML =
            formatCurrency(receiveAmount);
        document.getElementById("modal-due-summary").innerHTML = formatCurrency(
