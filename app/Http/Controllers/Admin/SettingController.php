...
class SettingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $general->update([
            'value' => $request->except('_token','_method','logo','favicon','common_header_logo','footer_logo','admin_logo', 'login_page_logo', 'login_page_image', 'dashboard_banner_image') + [
                    ...
                    'dashboard_banner_image' => $request->dashboard_banner_image ? $this->upload($request, 'dashboard_banner_image', $general->value['dashboard_banner_image'] ?? null) : ($general->value['dashboard_banner_image'] ?? null),
                ]
        ]);
