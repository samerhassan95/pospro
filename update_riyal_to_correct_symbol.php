...
/**
 * تحديث رمز الريال السعودي إلى "ر.س"
 * Update Saudi Riyal symbol to "ر.س"
 */
...
try {
    echo "بدء تحديث رمز الريال السعودي إلى ر.س\n";
    echo "Starting Saudi Riyal symbol update to ر.س\n\n";
